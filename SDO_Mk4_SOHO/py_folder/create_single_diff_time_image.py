...
if __name__ == "__main__":
    ...
    target_time_str = "2022-06-13T03:24:45"
    ...
    output_path = Path(f"/mnt/d/wsl/home/kinno-7010/Research_data/SDO_Mk4_SOHO/CME_measurement/diff_from_time_image/diff_from_time_image_{target_time_str.replace(':', '')}.png")
