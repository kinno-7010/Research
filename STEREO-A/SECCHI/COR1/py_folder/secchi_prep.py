...
def main():
    ...
    # テスト用のファイル
    test_files = [
        "/mnt/d/wsl/home/kinno-7010/Research_data/STEREO-A/SECCHI/COR1/Rawdata/20220613_032136_n4c1A.fts"
    ]
    ...
    try:
        processed_images, processed_headers, cosmic_reports = prep.process_files(
            ...
            write_png=True,
            write_fits=True,
            savepath="/mnt/d/wsl/home/kinno-7010/Research_data/STEREO-A/SECCHI/COR1/py_folder",
            rotate_on=True,
            smask_on=True,
            calibrate_off=False
        )
